<%@ Page Title="" Language="C#" MasterPageFile="~/Management/Management.Master" AutoEventWireup="true" CodeBehind="Departure.aspx.cs" Inherits="HotelManagement.Management.Departure" %>
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-home"></i>
                                        <span class="caption-subject font-green-sharp bold uppercase">Departure List </span>
                                    </div>                                
                                </div>
                                

                                <asp:Panel ID="pnl" runat="server" ScrollBars="Auto">
                                        <asp:GridView ID="GrdDepartureList" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Guest Name">
                                                          ...
                                                          <asp:TemplateField HeaderText="Status" ItemStyle-Width="80">
                                                            <ItemTemplate>
                                                                   <asp:Label ID="lblStatus" runat="server" Text='<%#Eval("Status")%>' CssClass="label label-sm label-danger"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>                                                         
