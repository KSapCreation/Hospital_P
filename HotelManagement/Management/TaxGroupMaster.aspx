<%@ Page Title="" Language="C#" MasterPageFile="~/Management/Management.Master" AutoEventWireup="true" CodeBehind="TaxGroupMaster.aspx.cs" Inherits="HotelManagement.Management.TaxGroupMaster" %>
										...
										<div class="row">
											<div class="col-md-12 col-sm-12">
												<div class="portlet green-meadow box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>Tax Group
														</div>													
													</div>
													<div class="portlet-body">
														<div class="row static-info">
                                                            ...
                                                            <div class="col-md-4 value">
                                                                   <asp:DropDownList ID="ddlGroupCode" runat="server" class="chzn-select" Width="100%" OnSelectedIndexChanged="SelecttaxGroupDetail" AutoPostBack="true"></asp:DropDownList>
                                                            </div> 
                                                            </div>
                                                        <div class="row static-info">
															<div class="col-md-2 name">
                                                        ...
                                                        <div class="row static-info">
                                                           ...
                                                           <asp:CheckBox ID="chkactive" runat="server" CssClass="form-control" />
                                                            ...
                                                            <div class="col-md-4 value">
                                                               <asp:DropDownList ID="ddltaxratecode" runat="server" CssClass="form-control" OnSelectedIndexChanged="BindTaxRateList" AutoPostBack="true"></asp:DropDownList>
                                                            </div>        --%>                                                                  
														</div>                                                                                                                                                                          <asp:Panel ID="pnl" runat="server" ScrollBars="Auto">
                                                            <asp:GridView ID="GrdtaxRateList" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Is Select" ItemStyle-Width="20" Visible="false">
                                                                        <ItemTemplate>                                                                                                  
                                                                            <asp:Label ID="lblProgramsID" runat="server" Text='<%#Eval("TaxrateID")%>' Visible="false"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Tax Name">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblName" runat="server" Text='<%#Eval("TaxRateID")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Tax Rate">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="Default" ItemStyle-Width="20">
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="chkactive" runat="server"  Checked='<%# Eval("Is_Default") %>'/>     
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
