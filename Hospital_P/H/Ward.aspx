<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="Ward.aspx.cs" Inherits="hotelManagement.H.M.Ward" %>
                         ...
                         <div class="page-bar">
                             <table style="width:40%;">
                                 <tr>
                                     ...
                                     <td>
                                        <asp:TextBox ID="txtSerach" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Enter Ward ID" ></asp:TextBox>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            Ward ID:                          
                                <asp:TextBox ID="txtWardID" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Ward" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            Ward:                          
                                <asp:TextBox ID="txtWard" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Ward" AutoCompleteType="Disabled"></asp:TextBox>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GrdWardMaster" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="GrdWardMaster_PageIndexChanging">
                                                    <Columns>                                                      
                                                        <asp:TemplateField HeaderText="Ward ID">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblAccountType" runat="server" Text='<%#Eval("WardID")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Ward Name">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblDescription" runat="server" Text='<%#Eval("WardName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
