<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="BedSystem.aspx.cs" Inherits="hotelManagement.H.M.BedSystem" %>
 ...
 <div class="page-bar">
                             <table style="width:40%;">
                                 <tr>
                                     ...
                                     <td>
                                        <asp:TextBox ID="txtSerach" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Enter Bed ID" ></asp:TextBox>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet yellow box">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-cogs"></i>Bed Master
                                                </div>
                                                <div class="tools">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            Bed ID:                          
                                <asp:TextBox ID="txtBedID" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Ward"  ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                        <div class="col-sm-6">
                                                        <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlWard" runat="server" CssClass="form-control"></asp:DropDownList>
                                                  ...
                                                  <div class="row">
                                                      <div class="col-sm-6">
                                                        <div class="form-group">
                                                            Bed Name:                          
                                <asp:TextBox ID="txtBed" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Ward" AutoCompleteType="Disabled"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            No of Bed:                          
                                <asp:TextBox ID="txtNo_of_Bed" runat="server" CssClass="form-control placeholder-no-fix" placeholder="No of Bed" AutoCompleteType="Disabled"></asp:TextBox>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GrdBedMaster" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="GrdBedMaster_PageIndexChanging">
                                                    <Columns>                                                      
                                                        <asp:TemplateField HeaderText="Ward ID">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblAccountType" runat="server" Text='<%#Eval("BedID")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Ward Name">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblDescription" runat="server" Text='<%#Eval("BedName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="No Of Beds">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblnoOfbed" runat="server" Text='<%#Eval("No_of_Bed")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                          <asp:TemplateField HeaderText="Update By">
                                                            <ItemTemplate>
                                                                     <asp:Label ID="lblAdmissionDate" runat="server" Text='<%#Eval("ModifyBy")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
