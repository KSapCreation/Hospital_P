<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="ParameterMaster.aspx.cs" Inherits="hotelManagement.H.ParameterMaster" %>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="ParameterMaster.aspx">Parameter Master</a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet yellow box">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Parameter Master
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            Parameter ID
                                      <asp:TextBox ID="txtTestID" runat="server" CssClass="form-control placeholder-no-fix" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            Parameter Name
                                      <asp:TextBox ID="txtParamterName" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <div class="form-group">
                                            Default Range
                                      <asp:TextBox ID="txtefault" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>                                            
                                        </div>
                                    </div>
                                </div>    
                ...
                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="GRdParameter" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="GRdParameter_PageIndexChanging">
                                                    <Columns>
                                                         <asp:TemplateField HeaderText="Option">
                                                            <ItemTemplate>
                                                                     <asp:LinkButton ID="lnkEdit" runat="server" OnClick="Update">
                                                                         <img src="img/edit.png" width="20" height="20" /></asp:LinkButton>
                                                                <asp:LinkButton ID="lnkDelete" runat="server" OnClick="Delete">
                                                                         <img src="img/delete.png" width="20" height="20" /></asp:LinkButton>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Parameter ID">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblProgramsID" runat="server" Text='<%#Eval("ParameterID")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Parameter Name">
                                                            <ItemTemplate>
                                                                     <asp:Label ID="lblDescription" runat="server" Text='<%#Eval("ParameterName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>  
                                                          <asp:TemplateField HeaderText="Default Range">
                                                            <ItemTemplate>
                                                                     <asp:Label ID="lblDefaultRange" runat="server" Text='<%#Eval("DefaultRange")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>                                                     
