<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="ProductKey.aspx.cs" Inherits="hotelManagement.H.ProductKey" %>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="Mapping.aspx">Product Key</a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet yellow box">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Product Key
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                         Company Name
                                     <asp:TextBox ID="txtCompanyName" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>                            
                                        </div>
                                         <div class="form-group">
                                         Expiry Date
                                     <asp:TextBox ID="txtExpireDate" runat="server" CssClass="form-control placeholder-no-fix" TextMode="Date"></asp:TextBox>      
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                           Product Key 1
                                     <asp:TextBox ID="txtCodeCompany" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                           Product Key 2
                                     <asp:TextBox ID="txtCodeExpireDate" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>
                                        </div>
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnSave" runat="server" Text="Generate Key" CssClass="btn btn-info" OnClick="GenerateKey" />                                    
                                </div>
