<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="ADT.aspx.cs" Inherits="hotelManagement.H.ADT" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-scrollable">                                            
                                                <asp:GridView ID="GrdPatientList" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="GrdPatientList_PageIndexChanging">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Patient Name">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblAccountType" runat="server" Text='<%#Eval("Name")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         ...
                                                         <asp:TemplateField HeaderText="Admitted Doctor">
                                                            <ItemTemplate>
                                                         ...
                                                         <asp:TemplateField HeaderText="Status">
                                                            <ItemTemplate>
                                                                     <asp:Label ID="lblAdmissionDate" runat="server" Text='<%#Eval("Status")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>                                            
