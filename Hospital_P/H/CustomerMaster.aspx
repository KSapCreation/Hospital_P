<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="CustomerMaster.aspx.cs" Inherits="hotelManagement.H.CustomerMaster" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                             <table style="width:40%;">
                                 <tr>
                                     ...
                                     <td>
                                        <asp:TextBox ID="txtSerach" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Enter Customer Name" ></asp:TextBox>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet yellow box">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Customer Master
                                </div>
                                <div class="tools">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            Customer Code:
                                      <asp:TextBox ID="txtAppNo" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Customer Code" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            Customer Name                                   
                                <asp:TextBox ID="txtCustomerName" runat="server" CssClass="form-control placeholder-no-fix" placeholder="Customer Name" AutoCompleteType="Disabled"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="GrdCustomerMaster" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="GrdCustomerMaster_PageIndexChanging">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Customer ID">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblAccountType" runat="server" Text='<%#Eval("CustomerCode")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Customer Name">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblDescription" runat="server" Text='<%#Eval("CustomerName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
