<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="TestMaster.aspx.cs" Inherits="hotelManagement.H.TestMaster" %>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>Master</li>
                        <li>
                            <a href="TestMaster.aspx">Test Master</a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet yellow box">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Test Master
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            Test Name
                                      <asp:TextBox ID="txtTestname" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>
                ...
                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GrdTest" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="GrdTest_PageIndexChanging">
                                                    <Columns>
                                                         ...
                                                         <asp:TemplateField HeaderText="Test Lab ID" Visible="true">
                                                            <ItemTemplate>
