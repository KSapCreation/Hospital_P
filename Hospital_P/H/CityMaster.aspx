<%@ Page Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="CityMaster.aspx.cs" Inherits="hotelManagement.H.M.CityMaster" %>
    ...
    <form id="form2" runat="server">
        <div class="page-content-wrapper">
            <div class="page-content">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        City Id
                                      <asp:TextBox ID="txtCityId" runat="server" CssClass="form-control placeholder-no-fix" placeholder="City Id" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            State                         
                                <asp:DropDownList ID="ddlState" runat="server" CssClass="form-control placeholder-no-fix">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtCityName" runat="server" CssClass="form-control placeholder-no-fix" placeholder="City Name" Width="50%" TextMode="SingleLine"></asp:TextBox>
                                </div>
                ...
                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GrdCity" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="GrdCity_PageIndexChanging">
                                                    <Columns>
                                                         ...
                                                         <asp:TemplateField HeaderText="City Name" Visible="false">
                                                            <ItemTemplate>
                                                                      <asp:Label ID="lblAccountType" runat="server" Text='<%#Eval("City_Code")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
