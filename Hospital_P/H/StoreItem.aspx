<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="StoreItem.aspx.cs" Inherits="hotelManagement.H.StoreItem" %>
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            Description
                                      <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control placeholder-no-fix" TextMode="MultiLine"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btnCleared" runat="server" Text="Clear" CssClass="btn btn-circle"  />
                                </div>
                            </div>
                        </div>
                        <!-- END ALERTS PORTLET-->
