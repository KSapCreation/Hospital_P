<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="LabReport.aspx.cs" Inherits="hotelManagement.H.LabReport" %>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>Report<i class="fa fa-angle-right"></i></li>
                        <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet yellow box">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Lab Report
                                </div>                             
                            </div>
                            <div class="portlet-body">
                                           <div class="row">
                                               <div class="col-sm-6">
                                                   <asp:TextBox ID="txtName" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>
                                               <asp:HiddenField ID="hfCustomerId" runat="server" />
                                               </div>
                                               <div class="col-sm-6">
                                                    <asp:Button ID="btnReport" runat="server" Text="Get Report" CssClass="btn btn-info" Visible="true" OnClick="btnPrint" />
                                               </div>
                                           </div>  
                ...
                <div class="row">
                    ...
                    <div class="col-sm-11">
                        ...
                        <rsweb:reportviewer id="RptLab" runat="server" width="800" borderstyle="Groove" borderwidth="5"></rsweb:reportviewer>
                        </asp:Panel>
                    </div>
        ...
        $(function () {
            $("[id$=txtName]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("Service.asmx/GetLabReport") %>',
