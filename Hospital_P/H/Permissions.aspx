<%@ Page Title="" Language="C#" MasterPageFile="~/H/Hospital.Master" AutoEventWireup="true" CodeBehind="Permissions.aspx.cs" Inherits="hotelManagement.H.Permissions" %>
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            ...
                            <a href="#">Secuirty Management</a>
                            <i class="fa fa-angle-right"></i>
                        </li>                       
                        <li>
                            <a href="Mapping.aspx">Modules Permissions</a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet yellow box">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                          User Name
                                     <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control placeholder-no-fix"></asp:TextBox>                                               <asp:HiddenField ID="hfCustomerId" runat="server" />
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                            <span> <br /> </span>
                                          <asp:Button ID="btnSerach" runat="server" CssClass="btn btn-arrow-link" Text=">>>" OnClick="SelectUserModule" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GrdModules" runat="server" AutoGenerateColumns="false" CssClass="table table-hover" OnPageIndexChanging="GrdModules_PageIndexChanging">
                                            <Columns>
                                                 <asp:TemplateField HeaderText="Select">
                                                            <ItemTemplate>
                                                                 <asp:CheckBox ID="chkModules" runat="server"  Checked='<%# Eval("SelectModule") %>'/>
                                                            <asp:Label ID="lblParameterID" runat="server" Text='<%#Eval("ModuleID")%>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                     </asp:TemplateField>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btnCleared" runat="server" Text="Clear" CssClass="btn btn-circle" OnClick="Clear" />
                                </div>
                            </div>
                        </div>
                        <!-- END ALERTS PORTLET-->
